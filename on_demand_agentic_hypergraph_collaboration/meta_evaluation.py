...
def run_full_process_llm2(data_dir, batch_size=500, ablation_config=None, no_optimization_tool=False):
    ...
    LLM2_PRIVATE_MESSAGE_POOL = {
        ...
        'aligned_entities': os.path.join(data_dir, "sup_pairs"),
        'aligned_entities_history': os.path.join(data_dir, "sup_pairs_history"),
...
def main(data_dir = "/home/dex/Desktop/entity_sy/AdaCoAgent_backup/data/icews_wiki/"):
    "" "sample usage" ""
